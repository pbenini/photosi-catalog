...
Voglio che modifichi il template della pagina del servizio in modo che includa questo div, così come te l'ho mostrato, nello spazio tra la navbar verticale e il grafico